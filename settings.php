...
// This is used for performance, we don't need to know about these settings on every page in Moodle, only when we are looking at the admin settings pages.
if ($ADMIN->fulltree) {
    ...
    // We list files in our own file area to add to the drop down. We will provide our own function to load all the presets from the correct paths.
    ...
    // Variable $brand-color. We use an empty default value because the default colour should come from the preset.
